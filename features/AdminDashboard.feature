...
Feature: Validate Dashboard
    ...
    Scenario: Verify content of table for Docs
      ...
      Then I scroll to element having xpath "//*[@id='DataTables_Table_0']//th[16]"
      Then element having xpath "//*[@id='DataTables_Table_0']//th[11]" should have partial text as "CD"
      Then element having xpath "//*[@id='DataTables_Table_0']//th[12]" should have partial text as "Appr Ord"
      Then element having xpath "//*[@id='DataTables_Table_0']//th[13]" should have partial text as "Escrow Dt"
      Then element having xpath "//*[@id='DataTables_Table_0']//th[14]" should have partial text as "Escrow Co"
      Then element having xpath "//*[@id='DataTables_Table_0']//th[15]" should have partial text as "PayOff Exp"
      Then element having xpath "//*[@id='DataTables_Table_0']//th[16]" should have partial text as "File Id"
    ...
    Scenario: Verify content of table for All
      ...
      Then element having xpath "//*[@id='table_all']//th[13]" should have partial text as "CD"
      Then element having xpath "//*[@id='table_all']//th[14]" should have partial text as "Appr Ord"
      Then element having xpath "//*[@id='table_all']//th[15]" should have partial text as "Escrow Dt"
      Then element having xpath "//*[@id='table_all']//th[16]" should have partial text as "Escrow Co"
      Then element having xpath "//*[@id='table_all']//th[17]" should have partial text as "PayOff Exp"
      Then element having xpath "//*[@id='table_all']//th[18]" should have partial text as "File Id"
