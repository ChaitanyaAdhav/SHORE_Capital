...
Feature: Validate Update Task Model
  ...
  Scenario: Navigate to update task model
    ...
    Then I enter "ddd" into input field having xpath "//div[@id='table_task_0_0_filter']//input[@type='search']"
    #Then I enter "AutomationTestPO" into input field having xpath "//div[@id='table_task_0_0_filter']//input[@type='search']"
  ...
  Scenario: Verify non editable fields in model
    Then element having name "up_task_type" should be disabled
    Then element having name "up_task_id" should be disabled
    Then element having name "up_created_by" should be disabled
    Then element having name "up_company_name" should be disabled
    Then element having name "up_file_name" should be disabled
    Then element having name "up_file_id" should be disabled
  ...
  Scenario: Verify updated communication should be displayed at top of table
    ...
    Then element having xpath "//tbody[@class='history_table_show']/tr[1]/td[3]" should have partial text as "InProgressTask"
  ...
  Scenario: Verify Update communication is displayed on dashboard
    ...
    Then I wait 15 seconds for element having xpath "//div[@id='table_task_0_0_filter']//input[@type='search']" to display
    #Then I enter "asdf" into input field having xpath "//div[@id='table_task_0_0_filter']//input[@type='search']"
