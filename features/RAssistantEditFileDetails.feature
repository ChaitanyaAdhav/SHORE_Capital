...
Feature: Test Edit File Details Model for Reverse Mortgage
   ...
   # Scenario: Verify that File Name is reflected as per entered while file creation
    #  Then element having id "id_file_id" should have partial text as "createfile::assistant::name"
...
#      Then element having xpath "//label[text()='Case Number']/../input" should have partial text as "createfile::assistant::caseno"
#
#    Scenario: Verify that Insurance is reflected as per entered while file creation
#      Then element having xpath "//label[text()='Insurance']/../input" should have partial text as "createfile::assistant::insurance"
#
...
#      Then element having xpath "//label[text()='HOA']/../input" should have partial text as "createfile::assistant::hoa"
#
...
#      Then element having xpath "//label[text()='Lender']/../input" should have partial text as "createfile::assistant::lender"
#
...
#      Then element having xpath "//label[text()='Escrow Company']/../input" should have partial text as "createfile::assistant::escrowcomp"
   ...
   # Scenario: Verify Received date is not changed on Dashboard
    ...
    Scenario: Reset Filename to original
      ...
      Then I sleep for 3 seconds
      Then I clear input field having xpath "//label[text()='File Name']/../input"
      Then I enter "createfile::assistant::name" into input field having xpath "//label[text()='File Name']/../input"
      Then I click on element having xpath "//*[@id='myModal']//button[@type='button'][2]"
      Then I sleep for 3 seconds
