...
Feature: Validate Update Task Model
    ...
    Scenario: To add communication and task
      Then I enter "ABC" into input field having xpath "//form[@id='add_task_form']//textarea[@name='communication']"
#      Then I enter "createtask::admin::communication1" into input field having xpath "//form[@id='add_task_form']//textarea[@name='communication']"
    ...
    Scenario: Verify task is created
      ...
      Then I enter "ABC" into input field having xpath "//div[@id='table_data_filter']//input[@type='search']"
      ...
      Then element having xpath "//tbody[@class='task_table_data']//tr[1]/td[5]/span" should have partial text as "ABC"
