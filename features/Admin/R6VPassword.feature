@radminviewpassword
Feature: Test View Page for Admin Login (Manage Password)
  ...
  Scenario: Open Type dropdown
    ...
    Then I wait 5 seconds for element having xpath "//label[text()='Type']/..//ul/li[2]/a/span" to display

  Scenario Outline: Verify types of password (Dropdown List)
    Then element having xpath "//label[text()='Type']/..//ul/li[<value>]/a/span" should have partial text as "<type>"
    Examples:
    |value|  |type|
    |2|  |Lender|
    |3|  |Credit|
  ...
  Scenario: Select Password type
    Then I click on element having xpath "//label[text()='Type']/..//ul/li[2]/a/span"
