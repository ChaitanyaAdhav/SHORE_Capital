@asstviewloan
Feature: Test View Page for Assistant Login (Loan Details)
  ...
  Scenario: Navigate to View page
    ...
    Then I wait 15 seconds for element having xpath "//table[@id='table_all']//td[text()='AutomationTestAsst']" to display
  ...
  Scenario: Verify available loan information
    ...
    Then element having xpath "(//table[@class='status-table'])[1]/tbody/tr[8]/td[2]" should have partial text as "createfile::assistant::lastname"
...
#    Then element having xpath "//form[@id='id_update_transaction_file']//*[@id='id_lender']" should have partial text "Test Lender asst"
