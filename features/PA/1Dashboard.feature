...
Feature: Validate PA Dashboard
    ...
    Scenario: Verify Content of table of Follow-up tab
      ...
      Then I wait 15 seconds for element having xpath "//*[@id='table_task_-1_-1']//th[2]" to display
      ...
      Then element having xpath "//*[@id='table_task_-1_-1']//th[3]" should have partial text as "WorkFlow"
      Then element having xpath "//*[@id='table_task_-1_-1']//th[4]" should have partial text as "Task Type"
      Then element having xpath "//*[@id='table_task_-1_-1']//th[5]" should have partial text as "Task Status"
      Then element having xpath "//*[@id='table_task_-1_-1']//th[6]" should have partial text as "Task Id"
      Then element having xpath "//*[@id='table_task_-1_-1']//th[7]" should have partial text as "File Id"
      Then element having xpath "//*[@id='table_task_-1_-1']//th[8]" should have partial text as "File Name"
      Then element having xpath "//*[@id='table_task_-1_-1']//th[9]" should have partial text as "Communication"
      Then I scroll to element having xpath "//*[@id='table_task_-1_-1']//th[13]"
      Then element having xpath "//*[@id='table_task_-1_-1']//th[10]" should have partial text as "Created By"
      Then element having xpath "//*[@id='table_task_-1_-1']//th[11]" should have partial text as "FollowUp Date"
      Then element having xpath "//*[@id='table_task_-1_-1']//th[12]" should have partial text as "Updated By"
      Then element having xpath "//*[@id='table_task_-1_-1']//th[13]" should have partial text as "Updated Date"
    ...
    Scenario: Verify Content of table of File Setup tab
      ...
      Then element having xpath "//*[@id='table_task_1_1']//th[9]" should have partial text as "Created By"
      Then I scroll to element having xpath "//*[@id='table_task_1_1']//th[12]"
      Then element having xpath "//*[@id='table_task_1_1']//th[10]" should have partial text as "Created Date"
      Then element having xpath "//*[@id='table_task_1_1']//th[11]" should have partial text as "Updated By"
      Then element having xpath "//*[@id='table_task_1_1']//th[12]" should have partial text as "Updated Date"
  #######################
  ##############
    ...
    Scenario: Verify Content of table of Open Escrow & Title tab
      ...
      Then element having xpath "//*[@id='table_task_1_2']//th[9]" should have partial text as "Created By"
      Then I scroll to element having xpath "//*[@id='table_task_1_2']//th[12]"
      Then element having xpath "//*[@id='table_task_1_2']//th[10]" should have partial text as "Created Date"
      Then element having xpath "//*[@id='table_task_1_2']//th[11]" should have partial text as "Updated By"
      Then element having xpath "//*[@id='table_task_1_2']//th[12]" should have partial text as "Updated Date"
  #######################
  ##############
    ...
    Scenario: Verify Content of table of Order Appraisal tab
      ...
      Then element having xpath "//*[@id='table_task_1_3']//th[9]" should have partial text as "Created By"
      Then I scroll to element having xpath "//*[@id='table_task_1_3']//th[12]"
      Then element having xpath "//*[@id='table_task_1_3']//th[10]" should have partial text as "Created Date"
      Then element having xpath "//*[@id='table_task_1_3']//th[11]" should have partial text as "Updated By"
      Then element having xpath "//*[@id='table_task_1_3']//th[12]" should have partial text as "Updated Date"
  #######################
  ##############
    ...
    Scenario: Verify Content of table of Order Evidence of Insurance tab
      ...
      Then element having xpath "//*[@id='table_task_1_4']//th[9]" should have partial text as "Created By"
      Then I scroll to element having xpath "//*[@id='table_task_1_4']//th[12]"
      Then element having xpath "//*[@id='table_task_1_4']//th[10]" should have partial text as "Created Date"
      Then element having xpath "//*[@id='table_task_1_4']//th[11]" should have partial text as "Updated By"
      Then element having xpath "//*[@id='table_task_1_4']//th[12]" should have partial text as "Updated Date"
  #######################
  ##############
    ...
    Scenario: Verify Content of table of Order VOE tab
      ...
      Then element having xpath "//*[@id='table_task_1_5']//th[9]" should have partial text as "Created By"
      Then I scroll to element having xpath "//*[@id='table_task_1_5']//th[12]"
      Then element having xpath "//*[@id='table_task_1_5']//th[10]" should have partial text as "Created Date"
      Then element having xpath "//*[@id='table_task_1_5']//th[11]" should have partial text as "Updated By"
      Then element having xpath "//*[@id='table_task_1_5']//th[12]" should have partial text as "Updated Date"
  #######################
  ##############
    ...
    Scenario: Verify Content of table of Order TaxTranscript tab
      ...
      Then element having xpath "//*[@id='table_task_1_6']//th[9]" should have partial text as "Created By"
      Then I scroll to element having xpath "//*[@id='table_task_1_6']//th[12]"
      Then element having xpath "//*[@id='table_task_1_6']//th[10]" should have partial text as "Created Date"
      Then element having xpath "//*[@id='table_task_1_6']//th[11]" should have partial text as "Updated By"
      Then element having xpath "//*[@id='table_task_1_6']//th[12]" should have partial text as "Updated Date"
  #######################
  ##############
    ...
    Scenario: Verify Content of table of Prepare Invoice tab
      ...
      Then element having xpath "//*[@id='table_task_1_7']//th[9]" should have partial text as "Created By"
      Then I scroll to element having xpath "//*[@id='table_task_1_7']//th[12]"
      Then element having xpath "//*[@id='table_task_1_7']//th[10]" should have partial text as "Created Date"
      Then element having xpath "//*[@id='table_task_1_7']//th[11]" should have partial text as "Updated By"
      Then element having xpath "//*[@id='table_task_1_7']//th[12]" should have partial text as "Updated Date"
  #######################
  ##############
    ...
    Scenario: Verify Content of table of Order Payoffs tab
      ...
      Then element having xpath "//*[@id='table_task_1_8']//th[9]" should have partial text as "Created By"
      Then I scroll to element having xpath "//*[@id='table_task_1_8']//th[12]"
      Then element having xpath "//*[@id='table_task_1_8']//th[10]" should have partial text as "Created Date"
      Then element having xpath "//*[@id='table_task_1_8']//th[11]" should have partial text as "Updated By"
      Then element having xpath "//*[@id='table_task_1_8']//th[12]" should have partial text as "Updated Date"
  #######################
  ##############
    ...
    Scenario: Verify Content of table of Docu Sign tab
      ...
      Then element having xpath "//*[@id='table_task_1_9']//th[9]" should have partial text as "Created By"
      Then I scroll to element having xpath "//*[@id='table_task_1_9']//th[12]"
      Then element having xpath "//*[@id='table_task_1_9']//th[10]" should have partial text as "Created Date"
      Then element having xpath "//*[@id='table_task_1_9']//th[11]" should have partial text as "Updated By"
      Then element having xpath "//*[@id='table_task_1_9']//th[12]" should have partial text as "Updated Date"
  #######################
  ##############
    Scenario: Verify Content of table of All tab
      ...
      Then element having xpath "//*[@id='table_task_0_0']//th[11]" should have partial text as "Created By"
      Then element having xpath "//*[@id='table_task_0_0']//th[12]" should have partial text as "Created Date"
      Then element having xpath "//*[@id='table_task_0_0']//th[13]" should have partial text as "Updated By"
      Then element having xpath "//*[@id='table_task_0_0']//th[14]" should have partial text as "Updated Date"
  #######################
