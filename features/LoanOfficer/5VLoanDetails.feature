@loviewloan
Feature: Test View Page for Loan Officer Login (Loan Details)
  ...
  Scenario: Navigate to View page
    ...
    Then I wait 15 seconds for element having xpath "//table[@id='table_all']//td[text()='AutomationTestLoan']" to display
