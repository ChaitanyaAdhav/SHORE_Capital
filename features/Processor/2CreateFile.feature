...
Feature: Create File Menu
    ...
    Scenario: Enter Borrower details
      Then I enter "createfile::processor::firstname" into input field having xpath "//input[@name='borrower_name']"
      Then I enter "createfile::processor::middlename" into input field having xpath "//input[@name='borrower_middle_name']"
      Then I enter "createfile::processor::lastname" into input field having xpath "//input[@name='borrower_last_name']"
      Then I enter "createfile::processor::suffix" into input field having xpath "//input[@name='borrower_suffix']"
...
#        |xlsx|
    ...
    Scenario: Verify File created alert is displayed
      Then element having xpath "//form[@id='Add_the_notes']//div[@role='alert']" should have partial text as "createfile::processor::lastname"
    ...
    Scenario: Add Processing instructions
      Then I enter "createfile::processor::instruction" into input field having xpath "//form[@id='Add_the_notes']//textarea"
...
########################
    ...
    Scenario: Verify File Name on Dashboard
      ...
      Then element having xpath "//*[@id='table_all']/tbody/tr[1]/td[2]" should have partial text as "createfile::processor::lastname"
    ...
    Scenario: Verify Lender on Dashboard
      Then element having xpath "//*[@id='table_all']/tbody/tr/td[7]" should have partial text as "createfile::processor::lender"
    ...
    Scenario: Verify Notes on Dashboard
      Then element having xpath "//*[@id='table_all']/tbody/tr/td[11]/span[1]" should have partial text as "createfile::processor::instruction"
    ...
    Scenario: Verify Escrow Company on Dashboard
      Then element having xpath "//*[@id='table_all']/tbody/tr/td[15]" should have partial text as "createfile::processor::escrowcomp"
